...
// Update PRIVATE_CONFIG if it exists
if (typeof PRIVATE_CONFIG !== 'undefined') {
  if (window.ENV_CONFIG.FORMSPREE_ENDPOINT) {
    PRIVATE_CONFIG.formspree.endpoint = window.ENV_CONFIG.FORMSPREE_ENDPOINT;
  }
  if (window.ENV_CONFIG.GITHUB_TOKEN) {
    PRIVATE_CONFIG.github.token = window.ENV_CONFIG.GITHUB_TOKEN;
  }
}
`;
